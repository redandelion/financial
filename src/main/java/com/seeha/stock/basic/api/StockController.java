...
//        params.add("count","100000");
    ...
    @GetMapping("/chats/render")
    private List<ResultVO> chatsRender(HttpServletResponse response){

        List<ResultVO> chatLine = stockService.getRender();
        response.addHeader("Access-Control-Allow-Origin","*");
        return chatLine;
    }
